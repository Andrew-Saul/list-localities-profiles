...
+ A total population of **`r total_population[1]`** people, where
**`r gender_breakdown %>% filter(sex == "M", hscp_locality == locality_list[1]) %>% pull(perc)`**
were male, and **`r over65[1]`%** were aged over 65.
...
In `r pop_max_year`, the total population of `r locality_list[1]` locality was `r total_population[[locality_list[1]]]`. The graph below shows the population distribution of the locality. Overall, **`r gender_breakdown[gender_breakdown$sex == "M", hscp_locality == locality_list[1]]$perc`** of the population are male, and **`r gender_breakdown[gender_breakdown$sex == "F", hscp_locality == locality_list[1]]$perc`** are female.

\newline
In `r pop_max_year`, the total population of `r locality_list[2]` locality was `r total_population[[locality_list[2]]]`. The graph below shows the population distribution of the locality. Overall, **`r gender_breakdown[gender_breakdown$sex == "M", hscp_locality == locality_list[2]]$perc`** of the population are male, and **`r gender_breakdown[gender_breakdown$sex == "F", hscp_locality == locality_list[2]]$perc`** are female.
...
Figure `r x` shows the historical population of `r locality_list[1]` and `r locality_list[2]` along with the NRS population projections. `r pop_graph_text[[1]]` `r pop_proj_text[[1]]`. `r pop_graph_text[[2]]` `r pop_proj_text[[2]]`. 
*Please see the footnotes for more information on how the population projections were calculated^1^.* 
