...
```{r pyramid, echo = FALSE, fig.width = 7, fig.height = 3.5, out.width="50%" , warning = FALSE, results=}
pop_pyramid_plot[[1]] 
pop_pyramid_plot[[2]] 
...
```{r timetrend, echo = FALSE, fig.width = 7, fig.height = 3, warning = FALSE}
pop_ts_plot
...
```{r simdmap, echo = FALSE, fig.width = 7, warning = FALSE}
simd_map
