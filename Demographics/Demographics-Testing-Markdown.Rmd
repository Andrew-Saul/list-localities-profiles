...
In `r pop_max_year`, the total population of `r locality_list[2]` locality was `r total_population[[locality_list[2]]]`. The graph below shows the population distribution of the locality. Overall, **`r gender_breakdown %>% filter(sex == "M", hscp_locality == locality_list[2]) %>% pull(perc)`** of the population are male, and **`r  gender_breakdown %>% filter(sex == "F", hscp_locality == locality_list[2]) %>% pull(perc)`** are female.
...
```{r echo = FALSE, fig.width = 7.5, fig.height = 8, warning = FALSE}
...
```{r echo = FALSE, fig.width = 9, fig.height = 8, warning = FALSE, fig.cap= "Bar charts showing the percentage change in population structure, split by age and sex, over the last five years"}
...
\newline
Table `r y` details the percentage of the `r locality_list[1]` 2016 population living in the 2016 SIMD Quintiles, the percentage of the `r pop_max_year` population living in the 2020 SIMD Quintiles, and their difference for comparison. 
...
\newline
Table `r y` details the percentage of the `r locality_list[2]` 2016 population living in the 2016 SIMD Quintiles, the percentage of the `r pop_max_year` population living in the 2020 SIMD Quintiles, and their difference for comparison. 
...
Figure `r x`  breaks down SIMD by domain in `r locality_list[1]` and `r locality_list[1]`.
...
```{r echo = FALSE, fig.width = 10, fig.height = 14, warning = FALSE, fig.cap = 'Bar graphs showing the percentage change of the population in each SIMD quintile by SIMD domain'}
